    	...
    	<MDBRow >
    		<MDBCol md = '2' className = "mb-xl-0 mb-4">
    			<MDBBtnGroup vertical>
        			<MDBBtn gradient="peach" size = 'lg' className="ml-0">Food</MDBBtn>
        			<MDBBtn gradient="purple" size = 'lg' style={{position: 'relative', top:'20px'}}>Clothing</MDBBtn>
        			<MDBBtn gradient="blue" size = 'lg' style={{position: 'relative', top:'40px'}}>Shelter</MDBBtn>
        			<MDBBtn gradient="aqua" size = 'lg' style={{position: 'relative', top:'60px'}}>Tranportation</MDBBtn>
      			</MDBBtnGroup>
    		</MDBCol>
